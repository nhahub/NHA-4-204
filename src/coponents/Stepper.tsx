...
// تعريف واجهة تفاصيل كل خطوة
interface Step {
  title: string;
  icon: LucideIcon;
}

// مصفوفة الخطوات مع تحديد نوع البيانات الثابتة
const steps: Step[] = [
...
// تعريف أنواع الـ Props للمكون
interface StepperProps {
  currentStep: number;
}

export default function Stepper({ currentStep }: StepperProps) {
  // تحديد نوع الـ Ref ليكون متوافقًا مع عنصر HTMLDivElement
